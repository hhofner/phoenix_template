defmodule PhoenixTemplate.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Ecto.Migrator,
        repos: Application.fetch_env!(:phoenix_template, :ecto_repos),
        skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:phoenix_template, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: PhoenixTemplate.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: PhoenixTemplate.Finch},
